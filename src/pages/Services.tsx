        ...
        <AnimatePresence mode="wait">
          {!previewData && !fullBlueprint && (
            ...
            >
              ...
              <form onSubmit={handleSearch} className="relative mb-8 flex justify-center">
                <div className="relative flex min-w-[300px] max-w-full w-full shadow-sm hover:shadow-md transition-shadow duration-300 rounded-[2rem] bg-white border border-brand-ink/20 focus-within:border-brand-ink focus-within:ring-4 focus-within:ring-brand-ink/5">
                  <TextareaAutosize
                    value={query}
                  ...
                  <div className="absolute bottom-2 right-2 flex items-center">
                    <button
                      ...
                      className="w-14 h-14 bg-brand-ink text-brand-bg rounded-full hover:bg-brand-ink/90 transition-all duration-300 disabled:opacity-50 flex items-center justify-center shrink-0 shadow-sm hover:shadow-md hover:-translate-y-0.5 cursor-pointer"
              ...
              <div className="text-left mb-16">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button
                    ...
                    className="text-xs uppercase tracking-widest font-bold text-brand-accent hover:text-brand-ink transition-colors cursor-pointer"
                  >
                ...
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    <button
                      ...
                      className="text-left text-sm text-brand-ink/70 hover:text-brand-ink transition-colors py-2 px-4 bg-brand-ink/5 border border-brand-ink/5 hover:border-brand-ink/20 cursor-pointer"
                    >
                      "{example}"
                    </button>
                  ))}
              ...
              <div className="mt-32 pt-20 border-t border-brand-ink/10 text-center">
                ...
                <a href="/about#contact" className="inline-flex items-center gap-3 px-10 py-5 bg-white border border-brand-ink/20 text-brand-ink text-xs uppercase tracking-widest font-bold hover:border-brand-ink transition-colors cursor-pointer">
                  ...
                  <div className="bg-white p-8 border border-brand-ink/10 shadow-xl max-w-md w-full text-center">
                    ...
                    <form onSubmit={handleUnlock} className="flex flex-col gap-4">
                      ...
                      <button
                        type="submit"
                        disabled={unlocking}
                        className="w-full py-4 bg-brand-ink text-brand-bg text-xs uppercase tracking-widest font-bold hover:bg-brand-ink/90 transition-colors disabled:opacity-50 cursor-pointer"
                      >
          ...
          {fullBlueprint && (
            ...
            >
              ...
              <h1 className="text-4xl font-serif mb-4 italic text-brand-ink">Thank you.</h1>
              <p className="text-brand-ink/60 text-lg mb-12 max-w-md mx-auto leading-relaxed">
                Your custom Growth Architecture Blueprint has been dispatched. Please check {unlockEmail} for a message from {unlockEmail.includes('@') ? 'our architecture team' : 'TheBoringStack'}.
              </p>
              <div className="flex flex-col gap-4 items-center">
                <button 
                  ...
                  className="px-10 py-5 bg-brand-ink text-brand-bg text-xs uppercase tracking-widest font-bold hover:bg-brand-accent transition-colors cursor-pointer"
                >
